...
const FeaturedProducts = () => {
  ...
  useEffect(() => {
    fetch(`${API_BASE_URL}/books/getBooks`)
      .then((res) => res.json())
  ...
  return (
    <section id="featured-products" className="bg-background py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center md:mb-16">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-text-muted">
            Explore our hand-picked selection of premium books, currated just
            for you.
          </p>
        </div>
